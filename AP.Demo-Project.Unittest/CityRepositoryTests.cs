...
<<<<<<< HEAD
        ...
        public async Task AddCity_Succeeds_WithValidData_AndLinksToCountry()
        {
            ...
            {
                var repo = new CityRepository(context);
                var dto = new CityDTO { Name = "Ghent", Population = 260_000, CountryId = 3 };
        ...
        public async Task AddCity_Throws_OnDuplicateName()
        {
            ...
            try
            {
                ...
                await repo.AddCity(new CityDTO { Name = "Bruges", Population = 118_000, CountryId = 3 });

                await Assert.ThrowsExceptionAsync<System.InvalidOperationException>(async () =>
                    await repo.AddCity(new CityDTO { Name = "Bruges", Population = 119_000, CountryId = 3 }));
            }
            finally
            {
                context.Dispose();
        ...
        public async Task AddCity_Throws_OnInvalidCountryId(int countryId)
        {
            ...
            try
            {
                ...
                await Assert.ThrowsExceptionAsync<System.ArgumentOutOfRangeException>(async () =>
                    await repo.AddCity(new CityDTO { Name = "TestCity", Population = 1, CountryId = countryId }));
            }
            finally
            {
                context.Dispose();
        ...
        public async Task AddCity_Throws_OnInvalidPopulation(long population)
        {
            ...
            try
            {
                ...
                await Assert.ThrowsExceptionAsync<System.ArgumentOutOfRangeException>(async () =>
                    await repo.AddCity(new CityDTO { Name = "PopTest", Population = population, CountryId = 1 }));
            }
            finally
            {
                context.Dispose();
        ...
        public async Task AddCity_TrimsName_AndEnforcesUniqueness()
        {
            ...
            try
            {
                ...
                await repo.AddCity(new CityDTO { Name = "Paris", Population = 2_200_000, CountryId = 4 }); // France = 4

                await Assert.ThrowsExceptionAsync<System.InvalidOperationException>(async () =>
                    await repo.AddCity(new CityDTO { Name = "  Paris  ", Population = 2_300_000, CountryId = 4 }));
            }
            finally
            {
                context.Dispose();
